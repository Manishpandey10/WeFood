# if you can use mozilla to run or just to see the API data(it's easier on mozilla ) or simply use "JSON VIEWER" extension in chrome or whatever browser are you using....
